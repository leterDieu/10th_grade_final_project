"""
Django settings for sbeps project.
...
ALLOWED_HOSTS.append('95.165.90.137')

CSRF_TRUSTED_ORIGINS = ['http://95.165.90.137:8000']
...
WSGI_APPLICATION = 'sbeps.wsgi.application'
